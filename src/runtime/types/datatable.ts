...
export interface TableColumn {
   ...
   */
  format?: (value: any, row: any) => string | any;
...
export interface TableConfig {
  ...
  /**
   * Data source - can be an array, function, URL, or object
   */
  dataSource: string | Function | object | any[];
...
export interface TableEvents {
   ...
   */
  onCellClick?: (value: any, key: string, row: any) => void;
}
