...
<template>
    <div class="container">
        ...
        <div class="example-section">
            ...
            <ArpixDataTable :columns="basicColumns" :data-source="basicData" table-class="basic-table" />
        ...
        <div class="example-section">
            ...
            <ArpixDataTable :columns="booleanColumns" :data-source="booleanData" />
            <div class="debug-info">
        ...
        <div class="example-section">
            ...
            <ArpixDataTable :columns="serverColumns" data-source="/api/arpix-data-table/data" pagination="server"
                :per-page="5" theme="dark" />
        </div>

        <div class="example-section">
            <h2 class="section-title">Advanced Example with Formatters</h2>
            <ArpixDataTable :columns="advancedColumns" :data-source="advancedData" :selectable="true"
                @selection-change="onSelectionChange" density="compact">
        ...
        <div class="example-section">
            ...
            <ArpixDataTable :columns="customRenderColumns" :data-source="customRenderData">
                ...
                <template #cell(tags)="{ value }">
                    <TagsList :tags="value" :color-map="tagColors" :clickable="true" @tag-click="handleTagClick" />
                </template>
            </ArpixDataTable>
        </div>
        ...
        <div class="example-section">
            ...
            <ArpixDataTable :columns="hasuraColumns" data-source="/api/playground/data" pagination="server"
                :per-page="10" :relations="hasuraRelations" />
            <div class="debug-info">
                <p>This example uses a custom endpoint that simulates a Hasura GraphQL API response with relation data.
                </p>
                <p>The endpoint is at <code>/api/playground/data</code> and returns employee data with department and
                    project
                    relations.</p>
            </div>
        </div>
        ...
        <div class="example-section">
            ...
            <div class="component-demo">
                ...
                <div class="demo-row">
                    <TagsList :tags="['Frontend', 'Backend', 'UI', 'API', 'Mobile', 'Database']" :color-map="tagColors"
                        :clickable="true" @tag-click="handleTagClick" />
                </div>
            </div>
        </div>
    </div>
